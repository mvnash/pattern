public class PatternRobots {
	...
	public static void main(String[] args) {
		Robot robot1 = new RobotImpl.RobotBuilder("Robot1").canon(10).shield(2).freq(100).build();
		...
		Robot robot2 = new RobotImpl.RobotBuilder("Robot2").canon(9).shield(3).freq(90).build();
